 ...
 * 
 * Geo-Coordinate-Conversion-Java Functionality for Converting between different
 * Geospatial Coordinate Systems (Lat/Lon, UTM, UPS, and MGRS) from the NASA
 * World Wind project (which they translated from the GDAL library written in
 * C), minus all of the dependencies on AWT, Graphics Libraries, their custom
 * Logging system, etc.
 *
 * This code is protected under the NASA Open Source Agreement (v1.3) [see
 * below], which is actually a pretty liberal license.
 *
 * Why would I go through the effort of stripping coordinate conversion out of
 * World Wind?
 *
 * Because the license is far more liberal than the other open source coordinate
 * conversion libraries on the web (especially those that have MGRS - which is
 * what I really need).
 *
 * ============================================================
 *
 * NASA WORLD WIND
 *
 * Copyright © 2004-2005 United States Government as represented by the
 * Administrator of the National Aeronautics and Space Administration. All
 * Rights Reserved. Copyright © 2004-2005 Contributors. All Rights Reserved.
 *
 ...
 * Government Agency Original Software Designation: ARC-15166-1 Government
 * Agency Original Software Title: NASA World Wind User Registration Requested.
 * Please send email with your contact information to Patrick.Hogan@nasa.gov
 * Government Agency Point of Contact for Original Software:
 * Patrick.Hogan@nasa.gov
 *
 * DEFINITIONS A. "Contributor" means Government Agency, as the developer of the
 * Original Software, and any entity that makes a Modification. B. "Covered
 * Patents" mean patent claims licensable by a Contributor that are necessarily
 * infringed by the use or sale of its Modification alone or when combined with
 * the Subject Software. C. "Display" means the showing of a copy of the Subject
 * Software, either directly or by means of an image, or any other device. D.
 * "Distribution" means conveyance or transfer of the Subject Software,
 * regardless of means, to another. E. "Larger Work" means computer software
 * that combines Subject Software, or portions thereof, with software separate
 * from the Subject Software that is not governed by the terms of this
 * Agreement. F. "Modification" means any alteration of, including addition to
 * or deletion from, the substance or structure of either the Original Software
 ...
 * released under this Agreement by Government Agency with Government Agency
 * designation ARC-15166-1 and entitled WorldWind, including source code, object
 * code and accompanying documentation, if any. H. "Recipient" means anyone who
 * acquires the Subject Software under this Agreement, including all
 ...
 * for any purpose.
 *
 * GRANT OF RIGHTS A. Under Non-Patent Rights: Subject to the terms and
 * conditions of this Agreement, each Contributor, with respect to its own
 * contribution to the Subject Software, hereby grants to each Recipient a
 * non-exclusive, world-wide, royalty-free license to engage in the following
 * activities pertaining to the Subject Software:
 *
 * Use Distribution Reproduction Modification Redistribution Display B. Under
 * Patent Rights: Subject to the terms and conditions of this Agreement, each
 * Contributor, with respect to its own contribution to the Subject Software,
 ...
 *
 * Use Distribution Reproduction Sale Offer for Sale C. The rights granted under
 * Paragraph B. also apply to the combination of a Contributor’s Modification
 * and the Subject Software if, at the time the Modification is added by the
 * Contributor, the addition of such Modification causes the combination to be
 * covered by the Covered Patents. It does not apply to any other combinations
 * that include a Modification.
 *
 * D. The rights granted in Paragraphs A. and B. allow the Recipient to
 * sublicense those same rights. Such sublicense must be under the same terms
 * and conditions of this Agreement.
 *
 * OBLIGATIONS OF RECIPIENT A. Distribution or Redistribution of the Subject
 * Software must be made under this Agreement except for additions covered under
 * paragraph 3H.
 *
 * Whenever a Recipient distributes or redistributes the Subject Software, a
 * copy of this Agreement must be included with each copy of the Subject
 * Software; and If Recipient distributes or redistributes the Subject Software
 * in any form other than source code, Recipient must also make the source code
 * freely available, and must provide with each copy of the Subject Software
 * information on how to obtain the source code in a reasonable manner on or
 * through a medium customarily used for software exchange. B. Each Recipient
 * must ensure that the following copyright notice appears prominently in the
 * Subject Software: Copyright (C) 2001 United States Government as represented
 ...
 * http:*opensource.arc.nasa.gov. Recipient’s name and personal information
 * shall be used for statistical purposes only. Once a Recipient makes a
 * Modification available, it is requested that the Recipient inform Government
 * Agency at the web site provided above how to access the Modification.
 *
 ...
 *
 * DISCLAIMER OF WARRANTIES AND LIABILITIES; WAIVER AND INDEMNIFICATION A. No
 * Warranty: THE SUBJECT SOFTWARE IS PROVIDED "AS IS" WITHOUT ANY WARRANTY OF
 ...
 * AGREEMENT.
 *
 * GENERAL TERMS A. Termination: This Agreement and the rights granted hereunder
 * will terminate automatically if a Recipient fails to comply with these terms
 * and conditions, and fails to cure such noncompliance within thirty (30) days
 * of becoming aware of such noncompliance. Upon termination, a Recipient agrees
 ...
 * may not be superseded, modified or amended except by further written
 ...
 * directed to the designated representative as follows: Patrick.Hogan@nasa.gov
 */
package app.beamcatcher.modelserver.thirdparty.berico;
