...
public class MGRSCanvas extends Canvas {
	...
	private Set<Marker> setMarkerCellSpace;

	public MGRSCanvas(final Set<Marker> pSetMarkerCellSpace) {
		this();
		this.setMarkerCellSpace = pSetMarkerCellSpace;
	}

	public MGRSCanvas() {
		System.out.println("Scale: " + SCALE_DOWN_FACTOR);
		System.out.println("Cell Width: " + MGRS_COLUMN_WIDTH_AT_100_KM2_RESOLUTION);
		System.out.println("Row Width: " + MGRS_ROW_HEIGHT_AT_100_KM2_RESOLUTION);
		System.out.println("Canvas Width: " + MGRS_CANVAS_WIDTH);
		System.out.println("Canvas Height: " + MGRS_CANVAS_HEIGHT);
