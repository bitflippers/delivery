 ...
 * All Rights Reserved.
 */
package app.beamcatcher.modelserver.thirdparty.berico.gov.nasa.worldwind.geom.coords;

import app.beamcatcher.modelserver.thirdparty.berico.gov.nasa.worldwind.avlist.AVKey;
import app.beamcatcher.modelserver.thirdparty.berico.gov.nasa.worldwind.geom.*;
...
class UTMCoordConverter
{
    ...
    /**
     * @return The coordinate hemisphere, either {@link app.beamcatcher.modelserver.thirdparty.berico.gov.nasa.worldwind.avlist.AVKey#NORTH} or {@link
     *         app.beamcatcher.modelserver.thirdparty.berico.gov.nasa.worldwind.avlist.AVKey#SOUTH}.
     */
     ...
     *
     * @param Zone       UTM zone.
     * @param Hemisphere The coordinate hemisphere, either {@link app.beamcatcher.modelserver.thirdparty.berico.gov.nasa.worldwind.avlist.AVKey#NORTH} or {@link
     *                   app.beamcatcher.modelserver.thirdparty.berico.gov.nasa.worldwind.avlist.AVKey#SOUTH}.
